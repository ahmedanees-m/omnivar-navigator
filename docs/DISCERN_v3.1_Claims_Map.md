...
| Novel-variant scoring (freq codes + PVS1/PS4 trees + injectable predictors) | `rules/variant_scoring.py` + tests | **code-complete**; H4 held-out AUC vs InterVar **data-gated** on real per-variant predictor scores |
